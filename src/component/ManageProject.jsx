                                        ...
                                        <div className="w-2/5 md:w-1/2  flex flex-row justify-center items-center">
                                            ...
                                            <div className="hidden md:block w-full h-full ">
                                                <div className="flex flex-row w-full  h-full">
                                                    ...
                                                    <div className="font-light  w-full h-full  border-b  text-start pl-4  flex justify-end items-center truncate "><p>{numberWithCommas(String(list[5]).length !=0 ? list[5] : list[4])}</p></div>
                                            ...
                                            <div className="flex flex-row h-full w-full justify-center md:w-1/3 items-center">
                                                <div className="font-light w-1/2 h-full border-b  text-end pl-4 flex justify-end items-center  text-black hover:text-gray-500 cursor-pointer">
                                                ...
                                                <div className="font-light w-1/2 h-full border-b  text-start pl-2 flex justify-center items-center text-red-400 hover:text-red-200 cursor-pointer">
                                ...
                                return (
                                    ...
                                    <div key={uuidv4()} className="w-full  flex flex-row justify-between bg-white  border-l-8 border-red-400 ">
                                        ...
                                        <div className="w-2/5 md:w-1/2 flex flex-row justify-end items-center">
                                            ...
                                            <div className="flex flex-row h-full w-full justify-center md:w-1/3 items-center">
                                                <div className=" font-light w-1/2 h-full border-b  text-end pl-4 flex justify-end items-center  text-blue-400 hover:text-blue-200 cursor-pointer">
                                ...
                                return (
                                    ...
                                    <div key={uuidv4()} className="w-full  flex flex-row justify-between bg-white  border-l-8 border-blue-400 ">
                                        ...
                                        <div className="w-2/5 md:w-1/2   flex flex-row justify-end items-center">
                                            ...
                                            <div className="flex flex-row h-full w-full justify-center md:w-1/3 items-center">
                                                <div className=" font-light w-1/2 h-full border-b  text-end pl-4 flex justify-end items-center  text-green-400 hover:text-green-200 cursor-pointer">
